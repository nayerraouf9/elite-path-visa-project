...
export default function UndoToast({
  ...
  return (
    <div className="fixed right-6 bottom-6 z-60 toast-stack">
      {stack.map(entry => (
        <div key={entry.uid} className="toast-item bg-white border rounded-lg shadow px-4 py-3 flex items-center gap-4">
