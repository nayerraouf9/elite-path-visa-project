...
export default function SearchBar() {
  return (
    <form
      className="w-full max-w-3xl mx-auto bg-white/95 rounded-2xl p-3 shadow-md animate-fade-in"
      role="search"
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-3 gap-2 items-center">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            type="submit"
            className="ml-2 btn-brand px-4 py-2 rounded-lg font-semibold shadow-lg hover:scale-105 transition-transform"
